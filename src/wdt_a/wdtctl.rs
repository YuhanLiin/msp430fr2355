...
impl From<WDTCNTCL_A> for bool {
    ...
    fn from(variant: WDTCNTCL_A) -> Self {
        match variant {
            WDTCNTCL_A::WDTCNTCL_0 => false,
            WDTCNTCL_A::WDTCNTCL_1 => true,
        }
    }
}
...
impl From<WDTTMSEL_A> for bool {
    ...
    fn from(variant: WDTTMSEL_A) -> Self {
        match variant {
            WDTTMSEL_A::WDTTMSEL_0 => false,
            WDTTMSEL_A::WDTTMSEL_1 => true,
        }
    }
}
...
impl<'a> WDTPW_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: WDTPW_A) -> &'a mut W {
