#[doc = "Reader of register SAC3DACSTS"]
pub type R = crate::R<u16, super::SAC3DACSTS>;
#[doc = "Writer for register SAC3DACSTS"]
pub type W = crate::W<u16, super::SAC3DACSTS>;
#[doc = "Register SAC3DACSTS `reset()`'s with value 0"]
impl crate::ResetValue for super::SAC3DACSTS {
    type Type = u16;
    #[inline(always)]
