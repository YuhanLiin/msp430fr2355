#[doc = "Register `TB3IV` reader"]
pub struct R(crate::R<TB3IV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TB3IV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TB3IV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TB3IV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TB3IV` writer"]
pub struct W(crate::W<TB3IV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TB3IV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TB3IV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TB3IV_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Timer_Bx Interrupt Vector Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tb3iv](index.html) module"]
pub struct TB3IV_SPEC;
impl crate::RegisterSpec for TB3IV_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [tb3iv::R](R) reader structure"]
impl crate::Readable for TB3IV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tb3iv::W](W) writer structure"]
impl crate::Writable for TB3IV_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TB3IV to value 0"]
impl crate::Resettable for TB3IV_SPEC {
    #[inline(always)]
