...
impl From<ACLKREQEN_A> for bool {
    ...
    fn from(variant: ACLKREQEN_A) -> Self {
        match variant {
            ACLKREQEN_A::ACLKREQEN_0 => false,
            ACLKREQEN_A::ACLKREQEN_1 => true,
        }
    }
}
...
impl From<MCLKREQEN_A> for bool {
    ...
    fn from(variant: MCLKREQEN_A) -> Self {
        match variant {
            MCLKREQEN_A::MCLKREQEN_0 => false,
            MCLKREQEN_A::MCLKREQEN_1 => true,
        }
    }
}
...
impl From<SMCLKREQEN_A> for bool {
    ...
    fn from(variant: SMCLKREQEN_A) -> Self {
        match variant {
            SMCLKREQEN_A::SMCLKREQEN_0 => false,
            SMCLKREQEN_A::SMCLKREQEN_1 => true,
        }
    }
}
...
impl From<MODOSCREQEN_A> for bool {
    ...
    fn from(variant: MODOSCREQEN_A) -> Self {
        match variant {
            MODOSCREQEN_A::MODOSCREQEN_0 => false,
            MODOSCREQEN_A::MODOSCREQEN_1 => true,
        }
    }
}
