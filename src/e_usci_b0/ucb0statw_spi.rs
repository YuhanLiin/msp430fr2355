#[doc = "Reader of register UCB0STATW_SPI"]
pub type R = crate::R<u16, super::UCB0STATW_SPI>;
#[doc = "Writer for register UCB0STATW_SPI"]
pub type W = crate::W<u16, super::UCB0STATW_SPI>;
#[doc = "Register UCB0STATW_SPI `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB0STATW_SPI {
    type Type = u16;
    #[inline(always)]
