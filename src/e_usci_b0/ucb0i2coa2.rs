#[doc = "Reader of register UCB0I2COA2"]
pub type R = crate::R<u16, super::UCB0I2COA2>;
#[doc = "Writer for register UCB0I2COA2"]
pub type W = crate::W<u16, super::UCB0I2COA2>;
#[doc = "Register UCB0I2COA2 `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB0I2COA2 {
    type Type = u16;
    #[inline(always)]
...
pub enum I2COA2_A {}
impl From<I2COA2_A> for u16 {
    #[inline(always)]
    fn from(variant: I2COA2_A) -> Self {
        match variant {}
    }
}
#[doc = "Reader of field `I2COA2`"]
pub type I2COA2_R = crate::R<u16, I2COA2_A>;
impl I2COA2_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u16, I2COA2_A> {
        use crate::Variant::*;
        match self.bits {
            i => Res(i),
        }
...
impl<'a> I2COA2_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: I2COA2_A) -> &'a mut W {
