...
#[doc = "Writer for register UCB0STATW"]
pub type W = crate::W<u16, super::UCB0STATW>;
#[doc = "Register UCB0STATW `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB0STATW {
    type Type = u16;
    #[inline(always)]
