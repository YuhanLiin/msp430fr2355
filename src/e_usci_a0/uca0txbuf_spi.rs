#[doc = "Reader of register UCA0TXBUF_SPI"]
pub type R = crate::R<u16, super::UCA0TXBUF_SPI>;
#[doc = "Writer for register UCA0TXBUF_SPI"]
pub type W = crate::W<u16, super::UCA0TXBUF_SPI>;
#[doc = "Register UCA0TXBUF_SPI `reset()`'s with value 0"]
impl crate::ResetValue for super::UCA0TXBUF_SPI {
    type Type = u16;
    #[inline(always)]
