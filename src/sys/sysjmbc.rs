...
impl From<JMBIN0FG_A> for bool {
    ...
    fn from(variant: JMBIN0FG_A) -> Self {
        match variant {
            JMBIN0FG_A::JMBIN0FG_0 => false,
            JMBIN0FG_A::JMBIN0FG_1 => true,
        }
    }
}
...
impl From<JMBIN1FG_A> for bool {
    ...
    fn from(variant: JMBIN1FG_A) -> Self {
        match variant {
            JMBIN1FG_A::JMBIN1FG_0 => false,
            JMBIN1FG_A::JMBIN1FG_1 => true,
        }
    }
}
...
impl From<JMBOUT0FG_A> for bool {
    ...
    fn from(variant: JMBOUT0FG_A) -> Self {
        match variant {
            JMBOUT0FG_A::JMBOUT0FG_0 => false,
            JMBOUT0FG_A::JMBOUT0FG_1 => true,
        }
    }
}
...
impl From<JMBOUT1FG_A> for bool {
    ...
    fn from(variant: JMBOUT1FG_A) -> Self {
        match variant {
            JMBOUT1FG_A::JMBOUT1FG_0 => false,
            JMBOUT1FG_A::JMBOUT1FG_1 => true,
        }
    }
}
...
impl From<JMBMODE_A> for bool {
    ...
    fn from(variant: JMBMODE_A) -> Self {
        match variant {
            JMBMODE_A::_16BIT => false,
            JMBMODE_A::_32BIT => true,
        }
    }
}
...
impl From<JMBCLR0OFF_A> for bool {
    ...
    fn from(variant: JMBCLR0OFF_A) -> Self {
        match variant {
            JMBCLR0OFF_A::JMBCLR0OFF_0 => false,
            JMBCLR0OFF_A::JMBCLR0OFF_1 => true,
        }
    }
}
...
impl From<JMBCLR1OFF_A> for bool {
    ...
    fn from(variant: JMBCLR1OFF_A) -> Self {
        match variant {
            JMBCLR1OFF_A::JMBCLR1OFF_0 => false,
            JMBCLR1OFF_A::JMBCLR1OFF_1 => true,
        }
    }
}
