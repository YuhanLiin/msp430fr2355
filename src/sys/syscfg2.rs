...
impl From<ADCPCTL0_A> for bool {
    ...
    fn from(variant: ADCPCTL0_A) -> Self {
        match variant {
            ADCPCTL0_A::ADCPCTL0_0 => false,
            ADCPCTL0_A::ADCPCTL0_1 => true,
        }
    }
}
...
impl From<ADCPCTL1_A> for bool {
    ...
    fn from(variant: ADCPCTL1_A) -> Self {
        match variant {
            ADCPCTL1_A::ADCPCTL1_0 => false,
            ADCPCTL1_A::ADCPCTL1_1 => true,
        }
    }
}
...
impl From<ADCPCTL2_A> for bool {
    ...
    fn from(variant: ADCPCTL2_A) -> Self {
        match variant {
            ADCPCTL2_A::ADCPCTL2_0 => false,
            ADCPCTL2_A::ADCPCTL2_1 => true,
        }
    }
}
...
impl From<ADCPCTL3_A> for bool {
    ...
    fn from(variant: ADCPCTL3_A) -> Self {
        match variant {
            ADCPCTL3_A::ADCPCTL3_0 => false,
            ADCPCTL3_A::ADCPCTL3_1 => true,
        }
    }
}
...
impl From<ADCPCTL4_A> for bool {
    ...
    fn from(variant: ADCPCTL4_A) -> Self {
        match variant {
            ADCPCTL4_A::ADCPCTL4_0 => false,
            ADCPCTL4_A::ADCPCTL4_1 => true,
        }
    }
}
...
impl From<ADCPCTL5_A> for bool {
    ...
    fn from(variant: ADCPCTL5_A) -> Self {
        match variant {
            ADCPCTL5_A::ADCPCTL5_0 => false,
            ADCPCTL5_A::ADCPCTL5_1 => true,
        }
    }
}
...
impl From<ADCPCTL6_A> for bool {
    ...
    fn from(variant: ADCPCTL6_A) -> Self {
        match variant {
            ADCPCTL6_A::ADCPCTL6_0 => false,
            ADCPCTL6_A::ADCPCTL6_1 => true,
        }
    }
}
...
impl From<ADCPCTL7_A> for bool {
    ...
    fn from(variant: ADCPCTL7_A) -> Self {
        match variant {
            ADCPCTL7_A::ADCPCTL7_0 => false,
            ADCPCTL7_A::ADCPCTL7_1 => true,
        }
    }
}
...
impl From<ADCPCTL8_A> for bool {
    ...
    fn from(variant: ADCPCTL8_A) -> Self {
        match variant {
            ADCPCTL8_A::ADCPCTL8_0 => false,
            ADCPCTL8_A::ADCPCTL8_1 => true,
        }
    }
}
...
impl From<ADCPCTL9_A> for bool {
    ...
    fn from(variant: ADCPCTL9_A) -> Self {
        match variant {
            ADCPCTL9_A::ADCPCTL9_0 => false,
            ADCPCTL9_A::ADCPCTL9_1 => true,
        }
    }
}
...
impl From<USCIBRMP_A> for bool {
    ...
    fn from(variant: USCIBRMP_A) -> Self {
        match variant {
            USCIBRMP_A::USCIBRMP_0 => false,
            USCIBRMP_A::USCIBRMP_1 => true,
        }
    }
}
...
impl From<RTCCKSEL_A> for bool {
    ...
    fn from(variant: RTCCKSEL_A) -> Self {
        match variant {
            RTCCKSEL_A::RTC_SMCLK => false,
            RTCCKSEL_A::RTC_ACLK => true,
        }
    }
}
