...
impl From<SYSBSLR_A> for bool {
    ...
    fn from(variant: SYSBSLR_A) -> Self {
        match variant {
            SYSBSLR_A::SYSBSLR_0 => false,
            SYSBSLR_A::SYSBSLR_1 => true,
        }
    }
}
...
impl From<SYSBSLOFF_A> for bool {
    ...
    fn from(variant: SYSBSLOFF_A) -> Self {
        match variant {
            SYSBSLOFF_A::SYSBSLOFF_0 => false,
            SYSBSLOFF_A::SYSBSLOFF_1 => true,
        }
    }
}
...
impl From<SYSBSLPE_A> for bool {
    ...
    fn from(variant: SYSBSLPE_A) -> Self {
        match variant {
            SYSBSLPE_A::SYSBSLPE_0 => false,
            SYSBSLPE_A::SYSBSLPE_1 => true,
        }
    }
}
