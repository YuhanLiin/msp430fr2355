...
impl From<SYSSNIV_A> for u16 {
    ...
    fn from(variant: SYSSNIV_A) -> Self {
        match variant {
            ...
            SYSSNIV_A::SVSLIFG => 2,
            SYSSNIV_A::UBDIFG => 4,
            SYSSNIV_A::ACCTEIFG => 6,
            SYSSNIV_A::SYSSNIV_8 => 8,
            SYSSNIV_A::SYSSNIV_10 => 10,
            SYSSNIV_A::SYSSNIV_12 => 12,
            SYSSNIV_A::SYSSNIV_14 => 14,
            SYSSNIV_A::SYSSNIV_16 => 16,
            SYSSNIV_A::VMAIFG => 18,
            SYSSNIV_A::JMBINIFG => 20,
            SYSSNIV_A::JMBOUTIFG => 22,
            SYSSNIV_A::CBDIFG => 24,
        }
    }
}
