...
#[doc = "Writer for register P9IV"]
pub type W = crate::W<u16, super::P9IV>;
#[doc = "Register P9IV `reset()`'s with value 0"]
impl crate::ResetValue for super::P9IV {
    type Type = u16;
    #[inline(always)]
...
#[doc = "Write proxy for field `P9IV`"]
pub struct P9IV_W<'a> {
    w: &'a mut W,
}
impl<'a> P9IV_W<'a> {
