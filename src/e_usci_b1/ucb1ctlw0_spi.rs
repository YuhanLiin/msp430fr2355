#[doc = "Reader of register UCB1CTLW0_SPI"]
pub type R = crate::R<u16, super::UCB1CTLW0_SPI>;
#[doc = "Writer for register UCB1CTLW0_SPI"]
pub type W = crate::W<u16, super::UCB1CTLW0_SPI>;
#[doc = "Register UCB1CTLW0_SPI `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB1CTLW0_SPI {
    type Type = u16;
    #[inline(always)]
