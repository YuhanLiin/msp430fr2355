#[doc = "Reader of register TB1IV"]
pub type R = crate::R<u16, super::TB1IV>;
#[doc = "Writer for register TB1IV"]
pub type W = crate::W<u16, super::TB1IV>;
#[doc = "Register TB1IV `reset()`'s with value 0"]
impl crate::ResetValue for super::TB1IV {
    type Type = u16;
    #[inline(always)]
