#[doc = "Reader of register CPDACCTL"]
pub type R = crate::R<u16, super::CPDACCTL>;
#[doc = "Writer for register CPDACCTL"]
pub type W = crate::W<u16, super::CPDACCTL>;
#[doc = "Register CPDACCTL `reset()`'s with value 0"]
impl crate::ResetValue for super::CPDACCTL {
    type Type = u16;
    #[inline(always)]
