...
impl From<UBDRSTEN_A> for bool {
    ...
    fn from(variant: UBDRSTEN_A) -> Self {
        match variant {
            UBDRSTEN_A::UBDRSTEN_0 => false,
            UBDRSTEN_A::UBDRSTEN_1 => true,
        }
    }
}
...
impl From<UBDIE_A> for bool {
    ...
    fn from(variant: UBDIE_A) -> Self {
        match variant {
            UBDIE_A::UBDIE_0 => false,
            UBDIE_A::UBDIE_1 => true,
        }
    }
}
...
impl From<CBDIE_A> for bool {
    ...
    fn from(variant: CBDIE_A) -> Self {
        match variant {
            CBDIE_A::CBDIE_0 => false,
            CBDIE_A::CBDIE_1 => true,
        }
    }
}
...
impl From<FRPWR_A> for bool {
    ...
    fn from(variant: FRPWR_A) -> Self {
        match variant {
            FRPWR_A::FRPWR_0 => false,
            FRPWR_A::FRPWR_1 => true,
        }
    }
}
...
impl From<FRLPMPWR_A> for bool {
    ...
    fn from(variant: FRLPMPWR_A) -> Self {
        match variant {
            FRLPMPWR_A::FRLPMPWR_0 => false,
            FRLPMPWR_A::FRLPMPWR_1 => true,
        }
    }
}
