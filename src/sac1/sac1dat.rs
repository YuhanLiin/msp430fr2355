#[doc = "Reader of register SAC1DAT"]
pub type R = crate::R<u16, super::SAC1DAT>;
#[doc = "Writer for register SAC1DAT"]
pub type W = crate::W<u16, super::SAC1DAT>;
#[doc = "Register SAC1DAT `reset()`'s with value 0"]
impl crate::ResetValue for super::SAC1DAT {
    type Type = u16;
    #[inline(always)]
